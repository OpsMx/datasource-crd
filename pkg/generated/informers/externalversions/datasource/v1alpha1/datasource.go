...
import (
	...
	datasourcev1alpha1 "github.com/opsmx/datasources-crd/pkg/apis/datasource/v1alpha1"
	versioned "github.com/opsmx/datasources-crd/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/opsmx/datasources-crd/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/opsmx/datasources-crd/pkg/generated/listers/datasource/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OpsmxV1alpha1().Datasources(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpsmxV1alpha1().Datasources(namespace).Watch(context.TODO(), options)
			},
		},
