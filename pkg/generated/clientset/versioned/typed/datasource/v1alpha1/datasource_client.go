...
// AnalyticsV1alpha1Client is used to interact with features provided by the analytics.opsmx.com group.
type AnalyticsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AnalyticsV1alpha1Client) Datasources(namespace string) DatasourceInterface {
